...
is_program_out 0, "pg_ctlcluster $v main start", 0, '', "starting cluster";
...
is_program_out 0, "pg_ctlcluster $v main restart", 0, '', "restarting cluster";
...
is_program_out 'postgres', "pg_ctlcluster $v main start -- -c", 0, '', "starting cluster with -c on the command line";
is_program_out 'postgres', "xargs -i awk '/core/ {print \$5}' /proc/{}/limits < /var/run/postgresql/$v-main.pid", 0, "unlimited\n", "soft core size is unlimited";
